 ...
 */
 ...
 $(function () {
      ...
      $("#btnConfirmPopup").click(function () {
    	  $('form[name=acctionSubject]').attr('action','deleteSubject');
    	  $('form[name=acctionSubject]').submit();
          $("#MyPopup").modal("hide");
  ...
  $(function () {
      $("#btnRegister").click(function () {
    	  $('form[name=acctionSubject]').attr('action','createSubject');
    	  $('form[name=acctionSubject]').submit();
  ...
  $(function () {
      ...
      $("#btnConfirmPopup1").click(function () {
    	  $('form[name=acctionSubject]').attr('action','updateSubject'); 
    	  $('form[name=acctionSubject]').submit();
          $("#MyPopup1").modal("hide");
