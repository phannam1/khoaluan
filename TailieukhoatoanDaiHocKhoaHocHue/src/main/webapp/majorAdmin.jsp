...
<script src="js/onclickMajor.js"></script>
<script src="js/btnclickMajor.js"></script>
...
<body>
	<div id="panelwrap">
		...
		<div class="header">
			...
			<div class="menu">
				<ul>
					...
					<li><a href="majorAdmin" class="selected">Ngành học</a></li>
		...
		<div class="tabcontent">
			<form name="acctionMajor" method="post"
			>
				<div class="form">

					<input id='inputMajorId' style="width: 500px; display: none"
						type="text" class="form_input" name="majorId" value="" />
				...
				<div id="right_content">
					...
					<div class="container-fluid">
						...
						<c:forEach items="${list}" var="list">
							<tr class="odd" onclick="functionclickMajor('${list.idMajor }','${list.nameMajor }','${list.createdBy }','${list.updatedBy }','${list.createdTime }','${list.updatedTime }')">
							<td>${list.idMajor }</td>
							<td>${list.nameMajor }</td>
