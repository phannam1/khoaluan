...
<script src="js/onclickSubject.js"></script>
<script src="js/btnClickSubject.js"></script>
...
<body>
	<div id="panelwrap">
			...
			<div class="menu">
				<ul>
					...
					<li><a href="categoryAdmin" >Chuyên ngành</a></li>
						...
						<li><a href="subjectAdmin" class="selected">Môn học</a></li>
		...
		<ul class="tabsmenu">
			...
			<li class="active"><a>Thông tin ngành học</a></li>

		</ul>
		<div class="tabcontent">
			<form name="acctionSubject" method="post"
			>
				<div class="form">

					<input id='inputSubjectId' style="width: 500px; display: none"
						type="text" class="form_input" name="subjectId" value="" />
				...
				<div id="right_content">
					...
					<div class="container-fluid">
						...
						<c:forEach items="${list}" var="list">
							<tr class="odd" onclick="functionclickMajor('${list.idSubject }','${list.nameSubject }','${list.createdBy }','${list.updatedBy }','${list.createdTime }','${list.updatedTime }')">
							<td style="display: none">${list.idSubject }</td>
